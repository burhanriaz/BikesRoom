...
namespace BikesRoom.Migrations
{
    ...
    [Migration("20220519113241_Add_oofice_phone_Number")]
    partial class Add_oofice_phone_Number
    {
            ...
            modelBuilder.Entity("BikeRoom.Models.BikesModel", b =>
                {
                    ...
                    b.HasIndex("MakedByFk");

                    b.ToTable("BikesModels");
                });

            modelBuilder.Entity("BikeRoom.Models.MakedByCompany", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
